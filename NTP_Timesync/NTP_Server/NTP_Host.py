# -*- coding: utf-8 -*-
"""
Created on Thu Apr 21 10:44:25 2022
...
try:
    ...
    with open('NTP.json', 'r') as file_reader:
        NTPConf = json.load(file_reader)
        
    ip=NTPConf["IP"]
    port=NTPConf["Port"]
    
    print("Configuration file imported succesfully.")
except Exception as e:
    print('Error in reading Configuration file (NTP.json) - ',e)
                
        
listenIp = ip
listenPort = port
print(listenIp,listenPort)
